...
lb1=Label(win,text='enter original cost: ',bg='white',fg='black',font=('Arial'))
lb1.place(x=10,y=20)
lb2=Label(win,text='enter net price: ',bg='white',fg='black',font=('Arial'))
lb2.place(x=10,y=60)
find = Button(win, text = "Find", fg = "Black",bg = "Red",command = gst_finder)
find.place(x=200,y=100)
lb3=Label(win,text='GST rate is: ',bg='white',fg='black',font=('Arial'))
lb3.place(x=10,y=140)
clear = Button(win, text = "Clear", fg = "Black",bg = "Red",command = clear)
...
#importing calender
import calendar
#defining function to print calendar for a given year
def ShowCal():
    new=Tk()
    new.title('Calendar')
...
print('list of marks(unsorted): ',user_list)
#defining a function that will take last element as pivot, and places it at its correct
...
#code that will perform the QuickSort function
arr=user_list
n=len(user_list)
quickSort(arr,0,n-1)
